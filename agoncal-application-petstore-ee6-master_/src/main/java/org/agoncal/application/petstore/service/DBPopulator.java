...
@DataSourceDefinition(
      //  className = "org.apache.derby.jdbc.EmbeddedDataSource",
		className = "org.h2.jdbcx.JdbcDataSource", //for jboss 7
		//className = "org.hsqldb.jdbc.JDBCDataSource", // for jboss 6
		// name = "java:global/jdbc/applicationPetstoreDS",
        		name = "java:jboss/datasources/ExampleDS",
        user = "sa",
         password = "", // for jboss 6
       // password = "sa", //for jboss 7
       databaseName = "localDB", // for jboss 6
       // databaseName = "test", // for jboss 7
